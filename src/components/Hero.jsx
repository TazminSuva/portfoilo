    ...
    <div className="w-full max-w-10xl grid grid-cols-1 md:grid-cols-12 items-center px-6 py-4">
          <div className="md:col-span-7 space-y-6">
            ...
            <div className="flex gap-4 pt-4">
              ...
              <a className="border border-yellow-500 text-yellow-500 px-8 py-3 rounded-md font-bold hover:bg-yellow-500 hover:text-black transition-all" href="./suva_A- CV.pdf" target="_blank" rel="noreferrer">See Resume</a>
            </div>
          </div>
